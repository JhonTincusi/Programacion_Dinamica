...
<head>
    ...
    <title>TRAVELLING SALESMAN PROBLEM CUSCO - PERU</title>
...
<!--:::::::Portada-001:::::::-->
    <div class="wrp">
        ...
        <div class="contenido">
            <div class="info">
                <h1>TRAVELLING SALESMAN PROBLEM - CUSCO - PERÚ</h1>
                <!--: <a href="#">Contactar</a>-->
            ...
            <div class="col-12 text p-2">
                <h3 class="row7">RESULTADOS</h3>
                <div class="tab-content p-2"><!--Lista de Operaciones a ahcer-->
                    <div class="row8" id="Operaciones">
                        <table class="table"><!--Esta Tabla no se muestra, en nuestra interfaz de resultado, pero si utilizamos el resultado que se obtiene en el balanceo-->
                            ...
                            <?php
                                ...
                                echo 'Número de Ubicaciones: '.count($Array)-1;
